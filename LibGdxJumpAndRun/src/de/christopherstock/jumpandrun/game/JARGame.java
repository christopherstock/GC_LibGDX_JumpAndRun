/*  $Id: JARGame.java 182 2013-09-30 14:45:09Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/trunk/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/JARGame.java $
    *****************************************************************************/
    public class JARGame
    {
        ...
        public static final void tick()
        {
            ...
            if ( !paused && JARHUD.overlayPanePause.isHidden() )
            {
                ...
                //animate walls, items and enemies
                ...
                JARLevel.getCurrent().iPlayer.iSprite.animateFrame();
