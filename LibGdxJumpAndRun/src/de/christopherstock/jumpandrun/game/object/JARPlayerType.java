/*  $Id: JARPlayerType.java 188 2014-02-17 08:10:14Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/trunk/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/object/JARPlayerType.java $
    *****************************************************************************/
    public enum JARPlayerType
    {
        EUser(                  JARSettings.Player.PLAYER_SPEED_WALKING_X,    JARSettings.Player.PLAYER_SPEED_JUMPING_X,    JARSettings.Player.PLAYER_JUMP_POWER_Y,   JARImage.EPlayerWalk,           JARImage.EPlayerStand,          JARSound.EKillEnemy     ),
