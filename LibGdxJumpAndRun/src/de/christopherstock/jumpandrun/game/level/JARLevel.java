/*  $Id: JARLevel.java 182 2013-09-30 14:45:09Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/trunk/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/level/JARLevel.java $
    *****************************************************************************/
                        ...
                        if ( blockY != null )
                        {
                            ...
                            switch ( wall.iBlock.getElevation() )
                            {
                                ...
                                case EDescending:
                                {
                                    ...
                                    {
                                        //check if the block is UNDER the rect's bottom SUBSTRACTING A TOLERANCE ( ascending won't work otherwise !! )
                                        final float BOTTOM_ASCENDING_TOLERANCE_MULTIPLIER = 0.2f;
                                        if ( blockY.floatValue() < nearestY && ( blockY.floatValue() >= rect.iTop + rect.iHeight - rect.iHeight * BOTTOM_ASCENDING_TOLERANCE_MULTIPLIER ) )
                                        {
                                            nearestY      = blockY.floatValue();
                                            nearestPlayer = null;
                                            nearestBlock  = wall.iBlock;
