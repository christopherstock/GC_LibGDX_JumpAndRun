/*  $Id: JARDebug.java 187 2014-02-14 16:20:27Z jenetic.bytemare@googlemail.com $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class JARDebug
    {
        ...
        public      static          Logger          spriteFrame                             = new Logger( "spriteFrame",    Logger.INFO     );
        ...
        public static final void drawDebugScreen( SpriteBatch batch )
        {
            ...
            if ( Debug.DRAW_SCREEN_REFERENCE_LINES )
            {
