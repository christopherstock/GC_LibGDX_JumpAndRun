/*  $Id: LibRect2D.java 181 2013-09-30 14:19:44Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/trunk/LibGdxJumpAndRun/src_lib/de/christopherstock/libgdx/lib/math/geom/LibRect2D.java $
    *****************************************************************************/
            ...
            )
            {
                switch ( elevated )
                {
                    ...
                    case EDescending:
                    {
                        ...
                        float collisionY = ( ( iHeight / 1 ) * progress / iWidth );
                    ...
                    case EAscending:
                    {
                        ...
                        if ( progress < 0       ) progress = 0;
                        if ( progress > iWidth  ) progress = iWidth;
                        float collisionY = iHeight - ( ( iHeight / 1 ) * progress / iWidth );
                        float ret        = iTop + collisionY;
                        return Float.valueOf( ret );
                    }
                }
