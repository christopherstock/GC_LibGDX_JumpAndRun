/*  $Id: LibRect2D.java 66 2013-08-27 14:42:36Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.4
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.4/LibGdxJumpAndRun/src_lib/de/christopherstock/libgdx/lib/math/geom/LibRect2D.java $
    *****************************************************************************/
            ...
            )
            {
                switch ( elevated )
                {
                    case EDescending:
                    {
                        ...
                        float collisionY = ( iHeight * progress / iWidth );
                    ...
                    case EAscending:
                    {
                        ...
                        if ( progress < 0       ) progress = 0;
                        if ( progress > iWidth  ) progress = iWidth;
                        float collisionY = iHeight - ( iHeight * progress / iWidth );
                        float ret        = iTop + collisionY;
                        return Float.valueOf( ret );
                    }
                    default:
