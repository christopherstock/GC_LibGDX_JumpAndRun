    ...
    **************************************************************************************/
    public abstract class LibMath
    {
        ...
        **************************************************************************************/
        ...
        public static final float getAngleCorrect( float x1, float y1, float x2, float y2 )
        {
            double distX = x2 - x1;
            double distY = y2 - y1;
            double angle = 0.0;
        ...
        **************************************************************************************/
        ...
        public static Vector2 getDistantPoint( float angle, float distance )
        {
            return getDistantPoint( null, angle, distance );
        }

        public static Vector2 getDistantPoint( Vector2 src, float angle, float distance )
        {
            return new Vector2
            (
                ( src == null ? 0.0f : src.x ) + ( distance * cosDeg( angle ) ),
                ( src == null ? 0.0f : src.y ) + ( distance * sinDeg( angle ) )
            );
        }
