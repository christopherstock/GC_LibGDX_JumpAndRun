/*  $Id: JARDebug.java 132 2013-09-12 07:50:01Z jenetic.bytemare@googlemail.com $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class JARDebug
    {
        ...
        private static final void drawScreenReferenceLines( SpriteBatch batch )
        {
            //vertical
            {
                LibDrawing.fillLine( batch, JARScreen.WIDTH * Camera.RATIO_CENTERING_X_HEADING_RIGHT, 0, JARScreen.WIDTH * Camera.RATIO_CENTERING_X_HEADING_RIGHT, JARScreen.HEIGHT, Colors.COLOR_REFERENCE_LINES );
                LibDrawing.fillLine( batch, JARScreen.WIDTH * Camera.RATIO_CENTERING_X_HEADING_LEFT,  0, JARScreen.WIDTH * Camera.RATIO_CENTERING_X_HEADING_LEFT,  JARScreen.HEIGHT, Colors.COLOR_REFERENCE_LINES );
            }

            //horizontal
            {
                LibDrawing.fillLine( batch, 0, JARScreen.HEIGHT * Camera.RATIO_CENTERING_Y_STANDING, JARScreen.WIDTH, JARScreen.HEIGHT * Camera.RATIO_CENTERING_Y_STANDING, Colors.COLOR_REFERENCE_LINES );
            }
        }
    }
