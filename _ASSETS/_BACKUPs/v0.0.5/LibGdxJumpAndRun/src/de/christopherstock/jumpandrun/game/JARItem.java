/*  $Id: JARItem.java 132 2013-09-12 07:50:01Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.5
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.5/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/JARItem.java $
    *****************************************************************************/
    public class JARItem extends JARGameObject
    {
        ...
        {
            super( GameObjectType.EItem, aItemType.iSprite );
            ...
            for ( JARItem item : items )
            {
                ...
                switch ( item.iItemState )
                {
                    ...
                    case EPickedMoving:
                    {
                        ...
                        item.iBlock.animate( true, false );
                        item.movePicked();
                        break;
                    }
