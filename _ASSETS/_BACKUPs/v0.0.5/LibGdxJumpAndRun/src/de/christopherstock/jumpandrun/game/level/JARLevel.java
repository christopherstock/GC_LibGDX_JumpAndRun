/*  $Id: JARLevel.java 132 2013-09-12 07:50:01Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.5
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.5/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/level/JARLevel.java $
    *****************************************************************************/
    public class JARLevel
    {
        ...
        *****************************************************************************/
        ...
        {
            JARImage imgBg     = iType.iImgBg;
            JARImage imgMiddle = iType.iImgMiddle;

            //draw bg image
            if ( Performance.PARALLAX_BG_SCROLLING )
            {
                int imgWidth  = (int)imgBg.getTotalWidth();
                int imgHeight = (int)imgBg.getTotalHeight();
                LibDrawing.drawImage
                (
                    batch,
                    imgBg.getTextureRegion(),
            ...
            else
            {
                ...
                LibDrawing.drawImage( batch, imgBg.getTextureRegion(), JARScreen.WIDTH / 2, JARScreen.HEIGHT, LibAnchor.ECenterBottom, LibUI.ALPHA_OPAQUE );
            }
            ...
            if ( Performance.PARALLAX_BG_SCROLLING )
            {
                float imgWidth      = imgMiddle.getTotalWidth();
                float imgHeight     = imgMiddle.getTotalHeight();
            ...
            {
                //draw image static on center bottom of the canvas
                LibDrawing.drawImage( batch, imgMiddle.getTextureRegion(), JARScreen.WIDTH / 2, JARScreen.HEIGHT, LibAnchor.ECenterBottom, LibUI.ALPHA_OPAQUE );
            }
        }
