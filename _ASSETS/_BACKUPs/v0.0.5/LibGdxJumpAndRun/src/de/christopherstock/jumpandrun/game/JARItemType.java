/*  $Id: JARItemType.java 132 2013-09-12 07:50:01Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.5
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.5/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/JARItemType.java $
    *****************************************************************************/
    public enum JARItemType
    {
        ...
        protected                   JARSprite       iSprite                             = null;
        ...
        public final LibPoint2D getAccordingTargetAnimationPoint()
        {
            switch ( this )
            {
                ...
                {
                    //right upper corner
                    return new LibPoint2D( JARScreen.WIDTH - HUD.OFFSET_HUD_BORDER_X - iSprite.iImg.getFrameWidth(), HUD.OFFSET_HUD_BORDER_Y );
                }
