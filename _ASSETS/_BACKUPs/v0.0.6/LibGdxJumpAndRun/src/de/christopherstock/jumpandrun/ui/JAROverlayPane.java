/*  $Id: JAROverlayPane.java 173 2013-09-25 06:53:34Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.6/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/ui/JAROverlayPane.java $
    *****************************************************************************/
    public class JAROverlayPane
    {
        private                         int                 iMaxTicks                   = 0;
        private                         int                 iTick                       = 0;
        private                         int                 iColor                      = 0;

        public JAROverlayPane( int aMaxTicks, Color aColor )
        {
            iMaxTicks   = aMaxTicks;
