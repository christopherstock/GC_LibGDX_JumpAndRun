/*  $Id: JARBlock.java 173 2013-09-25 06:53:34Z jenetic.bytemare@googlemail.com $
 *  ============================================================================
 */
    ...
    *   @version    0.0.6
    *   @link       $URL: https://libgdxjumpandrun.googlecode.com/svn/tags/v0.0.6/LibGdxJumpAndRun/src/de/christopherstock/jumpandrun/game/JARBlock.java $
    *****************************************************************************/
    public class JARBlock
    {
        ...
        public void animate( boolean changeFrame, boolean swing )
        {
            ...
            if ( changeFrame )
            {
                iParentGameObject.iSprite.animate();
            }
        ...
        public void drawDebug( SpriteBatch batch, LibCoordinate2D camera )
        {
            ...
            if ( iElevation != null )
            {
                switch ( iElevation )
                {
                    ...
                    case EAscending:
                    {
                        LibPoint2D leftTop      = new LibPoint2D( iRect.iLeft - camera.getX(),                  iRect.iTop  - camera.getY() + ( iRect.iHeight / 2 ) );
                        LibPoint2D rightTop     = new LibPoint2D( iRect.iLeft - camera.getX() + iRect.iWidth,   iRect.iTop  - camera.getY()                         );
                        LibPoint2D rightBottom  = new LibPoint2D( iRect.iLeft - camera.getX() + iRect.iWidth,   iRect.iTop  - camera.getY() + ( iRect.iHeight / 2 ) );
                    ...
                    case EDescending:
                    {
                        ...
                        LibPoint2D rightTop     = new LibPoint2D( iRect.iLeft - camera.getX() + iRect.iWidth,   iRect.iTop  - camera.getY() + ( iRect.iHeight / 2 ) );
                        LibPoint2D leftBottom   = new LibPoint2D( iRect.iLeft - camera.getX(),                  iRect.iTop  - camera.getY() + ( iRect.iHeight / 2 ) );
